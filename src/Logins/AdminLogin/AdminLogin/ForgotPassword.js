                    ...
                    <div className='password-info col-12'>
                        ...
                        <div className='pswd-input col-12' style={{ margin: '3% 0 0 5%' }}>
                            ...
                            <input className='col-9' type='email' value={inpval.email} onChange={setVal}  name="email" id="email" placeholder='Email Address'
                                style={{ padding: '10px', borderRadius: '10px', margin: '2% 0 0 0', border: '2px solid rgb(58,145,245)', fontSize: '13px' }} />
                        </div>
                        <div className='reset-button col-5' style={{ margin: '3% 0 1% 5%', display: 'flex', gap: '20px' }}>
                            
                            <button type='submit' onClick={getresetlink} className='col-5' style={{ padding: '5px', borderRadius: '10px', cursor: 'pointer', border: 'none', background: '#10abf3', color: '#fff', fontSize: '12px' }}>Get Reset Link</button>
                            <div>
                                <NavLink to='/' >
                                    <button type='submit' className='col-12' style={{ padding: '5px', borderRadius: '10px', cursor: 'pointer', fontSize: '12px', color: 'blue', border: '1px solid blue', background: 'none' }}>Back to Login</button>
                                </NavLink>
                            </div>
